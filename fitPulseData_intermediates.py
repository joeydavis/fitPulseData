...
def poolOverResid1000(P, y, t):
    k = qMS.growthRate(47)
    return y - qMS.poolOverFunc(k, t, P)


def poolOverResid10(P, y, t):
    k = qMS.growthRate(92)
    return y - qMS.poolOverFunc(k, t, P)
...
def fitPoolOverSizes(Proteins, medDict10, medDict1000):
    p0_10 = 0.01
    p0_1000 = 0.01
    ...
    for prot in Proteins:
        ...
        p_10 = optimize.leastsq(poolOverResid10, [p0_10], args=(meas10,ts10))
        p_1000 = optimize.leastsq(poolOverResid1000, [p0_1000], args=(meas1000,ts1000))
        protPoolDict[prot] = {'10':p_10[0][0], '1000':p_1000[0][0]}
    return protPoolDict
